...
If you are looking for more information on epidemics check out the [SIR Model]
(https://en.wikipedia.org/wiki/Compartmental_models_in_epidemiology "Wikipedia article on models used in epidemiology) and the [Basic Reproduction Number](https://en.wikipedia.org/wiki/Basic_reproduction_number "Wikipedia Article on the Basic Reproduction Number)
